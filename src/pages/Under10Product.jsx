...
// export default function Under10Product(){
//     return(
//        <>
//        <h1>Under10Product</h1>
//        </>
//     )
...
import jewelrry from '../assets/jewelrry.png'
...
export default function MenProduct() {
  ...
  async function fetching(){
    ...
    let res=await axios({
      method:"get",
      url:"https://khols-website-server.onrender.com/underTenProducts",
    })
    if(res.status===200){
          ...
          <Box>
              ...
              <Flex gap={4} mb={12}mt={8} justify={'space-around'} >
                ...
                <Box>
                 ...
                 <Text _hover={{textDecoration:'underline'}} textAlign={'center'}><b>women</b></Text>
                </Box>
                <Box>
                 <Image src={men}  h={'130px'} ></Image>
                 <Text   _hover={{ textDecoration: 'underline' }}  textAlign={'center'}><b>men</b></Text>
                </Box>
                <Box>
                 <Image src={kids}  h={'130px'}  ></Image>
                 <Text _hover={{textDecoration:'underline'}} textAlign={'center'}><b>Kids
                 </b></Text>
                </Box>
                <Box>
                 <Image src={jewelrry}  h={'130px'}  ></Image>
                 <Text _hover={{textDecoration:'underline'}} textAlign={'center'}><b>jewellery
                 </b></Text>
                </Box>
                <Box>
                 <Image src={home}  h={'130px'}  ></Image>
                 <Text _hover={{textDecoration:'underline'}} textAlign={'center'}><b>home
                 </b></Text>
                </Box>
